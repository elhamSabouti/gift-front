...
const ProductCard = ({props}) => {
    return (
        <div className={`w-[375px] h-[120px] bg-[#132D46] rounded-[17px] border-b-2  flex justify-center items-center`} style={{borderBottomColor:props.borderColor}}>
            ...
            <div className="w-[25%] h-full flex flex-col justify-center bg- text-right gap-1">
                <p className={` text-[20px]`} style={{color:props.textColor}}>{props.title}</p>
