...
const Banner = ({props}) => {
    return (
        <div className= {`w-full h-[159px] cursor-pointer  rounded-[38px]  flex justify-between`} style={{backgroundImage:`linear-gradient(to right, ${props.color_to} , ${props.color_main} , ${props.color_from})`}}>
